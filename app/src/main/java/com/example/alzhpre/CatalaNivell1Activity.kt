...
import com.example.alzhpre.catala_nivell1.CatalaAsociarImagenesActivity
import com.example.alzhpre.catala_nivell1.CatalaCalculActivity
import com.example.alzhpre.catala_nivell1.CatalaPreguntesPersonalsActivity
import com.google.firebase.auth.FirebaseAuth
import com.google.firebase.database.DatabaseReference
import com.google.firebase.database.FirebaseDatabase

class CatalaNivell1Activity : AppCompatActivity() {
    private lateinit var database: DatabaseReference
    @SuppressLint("ClickableViewAccessibility")
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.catala_activity_nivell1)

        database = FirebaseDatabase.getInstance().reference
        val nivell1: View = findViewById(R.id.nivell1)
        ...
        findViewById<Button>(R.id.btnPreguntesPersonals).setOnClickListener {
            ...
            val intent = Intent(this, CatalaPreguntesPersonalsActivity::class.java)
        ...
        findViewById<Button>(R.id.btnMemoritzacio).setOnClickListener {
            saveCorrectClick(currentUserUid)
            val intent = Intent(this, CatalaAsociarImagenesActivity::class.java)
            startActivity(intent)
        }
        ...
        findViewById<Button>(R.id.btnCalculs).setOnClickListener {
            saveCorrectClick(currentUserUid)
            val intent = Intent(this, CatalaCalculActivity::class.java)
            startActivity(intent)
        }

        nivell1.setOnTouchListener { view, motionEvent ->
