...
import com.example.alzhpre.databinding.CatalaActivityQuestionsBinding
...
class CatalaQuestionsActivity: AppCompatActivity() {

    private lateinit var binding: CatalaActivityQuestionsBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = CatalaActivityQuestionsBinding.inflate(layoutInflater)
