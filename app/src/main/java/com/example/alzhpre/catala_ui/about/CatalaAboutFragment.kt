package com.example.alzhpre.catala_ui.about
...
import com.example.alzhpre.databinding.CatalaFragmentAboutBinding
import com.example.p1prova.catala_ui.about.CatalaAboutViewModel
...
class CatalaAboutFragment : Fragment() {

    private var _binding: CatalaFragmentAboutBinding? = null
    ...
    private fun saveAvatarToDatabase(avatarResId: Int) {
        ...
        databaseReference.child(currentUserUid).child("Imagen").child("imag").setValue(avatarName)
            .addOnSuccessListener {
                Toast.makeText(requireContext(), "Avatar successfully updated", Toast.LENGTH_SHORT)
                    .show()
