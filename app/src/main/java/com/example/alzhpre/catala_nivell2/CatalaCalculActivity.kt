package com.example.alzhpre.catala_nivell2
...
import com.example.alzhpre.databinding.CatalaNivell2ActivityCalculBinding
...
class CatalaCalculActivity : AppCompatActivity() {
    private lateinit var binding: CatalaNivell2ActivityCalculBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.catala_nivell2_activity_calcul)
        binding = CatalaNivell2ActivityCalculBinding.inflate(layoutInflater)
        ...
        val calculactivity_2: View = findViewById(R.id.calculactivity_2)
        ...
        calculactivity_2.setOnTouchListener { view, motionEvent ->
