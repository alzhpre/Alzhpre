...
import com.example.alzhpre.databinding.CatalaNivell2ActivityAsociarImagenesBinding
...
class CatalaAsociarImagenesActivity : AppCompatActivity() {
    ...
    private lateinit var binding: CatalaNivell2ActivityAsociarImagenesBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.catala_nivell2_activity_asociar_imagenes)
        binding= CatalaNivell2ActivityAsociarImagenesBinding.inflate(layoutInflater)
