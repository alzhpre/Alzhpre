...
import com.example.alzhpre.databinding.ActivityFamilySignUpBinding
import com.google.firebase.auth.FirebaseAuth
import com.google.firebase.database.DatabaseReference
import com.google.firebase.database.FirebaseDatabase

class FamilySignUpActivity: AppCompatActivity() {
    private lateinit var binding: ActivityFamilySignUpBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivityFamilySignUpBinding.inflate(layoutInflater)
                            ...
                            if (it.isSuccessful) {
                                ...
                                currentUser?.sendEmailVerification()?.addOnCompleteListener { task ->
                                    if (task.isSuccessful) {
                                        ...
                                        saveFamilyUserToDatabase(username, familyEmail, email)
    ...
    private fun saveFamilyUserToDatabase(username: String, familyUser: String, email: String) {
