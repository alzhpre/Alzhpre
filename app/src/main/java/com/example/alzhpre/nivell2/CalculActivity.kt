...
import com.example.alzhpre.databinding.Nivell2ActivityCalculBinding
...
class CalculActivity : AppCompatActivity() {
    private lateinit var binding: Nivell2ActivityCalculBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.nivell2_activity_calcul)
        binding = Nivell2ActivityCalculBinding.inflate(layoutInflater)
