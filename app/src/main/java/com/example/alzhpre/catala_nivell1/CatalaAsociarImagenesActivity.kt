...
import com.example.alzhpre.databinding.CatalaActivityAsociarImagenesBinding
...
class CatalaAsociarImagenesActivity : AppCompatActivity() {
    ...
    private lateinit var binding: CatalaActivityAsociarImagenesBinding
    ...
    private var incorrectAnswers = 1
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_asociar_imagenes)
        binding= CatalaActivityAsociarImagenesBinding.inflate(layoutInflater)
        setContentView(binding.root)

        database = FirebaseDatabase.getInstance().reference
        val asociarimagenes_1: View = findViewById(R.id.asociarimagenes_1)
        ...
        asociarimagenes_1.setOnTouchListener { view, motionEvent ->
