...
import com.example.alzhpre.databinding.FragmentAboutFamiliarBinding
...
class AboutFamiliarFragment : Fragment() {

    private var _binding: FragmentAboutFamiliarBinding? = null
    ...
    override fun onCreateView(
        ...
        ViewModelProvider(this).get(com.example.p1prova.ui_familiar.about.AboutViewModel::class.java)
        _binding = FragmentAboutFamiliarBinding.inflate(inflater, container, false)
        return binding.root
    }
