...
import com.example.alzhpre.databinding.Nivell3ActivityCalculBinding
...
class CalculActivity : AppCompatActivity() {
    private lateinit var binding: Nivell3ActivityCalculBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.nivell3_activity_calcul)
        binding = Nivell3ActivityCalculBinding.inflate(layoutInflater)
