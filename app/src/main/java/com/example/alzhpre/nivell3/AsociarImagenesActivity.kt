package com.example.alzhpre.nivell3
...
import com.example.alzhpre.databinding.Nivell3ActivityAsociarImagenesBinding
...
class AsociarImagenesActivity : AppCompatActivity() {
    ...
    // Lista de palabras
    private val palabras = listOf("Perro", "Gato", "Pájaro", "Pez", "Conejo")
    ...
    private lateinit var binding: Nivell3ActivityAsociarImagenesBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.nivell3_activity_asociar_imagenes)
        binding= Nivell3ActivityAsociarImagenesBinding.inflate(layoutInflater)
