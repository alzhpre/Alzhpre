...
import com.example.alzhpre.SignUpActivity
...
class PreguntesPersonalsActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_nivell1_preguntes_personals)
