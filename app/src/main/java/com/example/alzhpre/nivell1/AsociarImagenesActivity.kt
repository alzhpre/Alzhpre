package com.example.alzhpre.nivell1
...
class AsociarImagenesActivity : AppCompatActivity() {
    ...
    private lateinit var binding: ActivityAsociarImagenesBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding= ActivityAsociarImagenesBinding.inflate(layoutInflater)
