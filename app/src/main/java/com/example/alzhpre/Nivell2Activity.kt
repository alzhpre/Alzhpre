...
import com.example.alzhpre.nivell1.AsociarImagenesActivity
import com.example.alzhpre.nivell1.CalculActivity
import com.example.alzhpre.nivell1.PreguntesPersonalsActivity
import com.google.firebase.auth.FirebaseAuth
import com.google.firebase.database.DatabaseReference
import com.google.firebase.database.FirebaseDatabase

class Nivell2Activity: AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        findViewById<Button>(R.id.btnPreguntesPersonals).setOnClickListener {
            ...
            val intent = Intent(this, com.example.alzhpre.nivell2.PreguntesPersonalsActivity::class.java)
        ...
        findViewById<Button>(R.id.btnMemoritzacio).setOnClickListener {
            saveCorrectClick(currentUserUid)
            val intent = Intent(this, com.example.alzhpre.nivell2.AsociarImagenesActivity::class.java)
            startActivity(intent)
        }
        ...
        findViewById<Button>(R.id.btnCalculs).setOnClickListener {
            saveCorrectClick(currentUserUid)
            val intent = Intent(this, com.example.alzhpre.nivell2.CalculActivity::class.java)
            startActivity(intent)
        }
