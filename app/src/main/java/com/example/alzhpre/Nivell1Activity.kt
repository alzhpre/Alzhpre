...
class Nivell1Activity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        findViewById<Button>(R.id.btnPreguntesPersonals).setOnClickListener {
            ...
            val intent = Intent(this, PreguntesPersonalsActivity::class.java)
        ...
        findViewById<Button>(R.id.btnMemoritzacio).setOnClickListener {
            saveCorrectClick(currentUserUid)
            val intent = Intent(this, AsociarImagenesActivity::class.java)
            startActivity(intent)
        }
