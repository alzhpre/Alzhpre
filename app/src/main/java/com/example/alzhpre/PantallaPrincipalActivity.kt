...
import com.example.alzhpre.databinding.ActivityPantallaPrincipalBinding
...
import com.example.alzhpre.ui.about.AboutFragment
import com.example.alzhpre.ui.graph.GraphFragment
import com.example.alzhpre.ui.home.HomeFragment
import com.example.alzhpre.ui.logout.LogoutFragment
        ...
        userRef.child("ClicsIncorrectos").addListenerForSingleValueEvent(object : ValueEventListener {
            override fun onDataChange(dataSnapshot: DataSnapshot) {
                ...
                userRef1.child("ClicsCorrectos").addListenerForSingleValueEvent(object : ValueEventListener {
                    ...
                    override fun onCancelled(databaseError: DatabaseError) {
                        // Manejar el error
                        Toast.makeText(this@PantallaPrincipalActivity, "Error al cargar los datos: ${databaseError.message}", Toast.LENGTH_SHORT).show()
                    }
                })
            }
    ...
    private fun cargarImagenPerfil() {
        ...
        userReference.addListenerForSingleValueEvent(object : ValueEventListener {
            override fun onDataChange(dataSnapshot: DataSnapshot) {
                ...
                Glide.with(this@PantallaPrincipalActivity)
                    .load(resId)
